...
Next, use the [quickstart](/docs/getting-started/mock-quickstart) to verify your application without external side effects, then [choose an integration](/docs/getting-started/choose-an-integration).
