...
The [architecture diagrams](/docs/concepts/architecture) show how route selection and per-target outcomes stay explicit.

For server integration shapes, see the [Node, Next.js, and Hono framework recipes](/docs/getting-started/framework-recipes).
