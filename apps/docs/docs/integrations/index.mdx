---
title: Integrations
description: Use Social SDK with frameworks, deployment platforms, data systems, and durable job runners.
---
...
Runtime integrations provide hosting or credential infrastructure around the SDK. They do not replace the platform adapter, your tenant authorization, or the delivery state you keep in your application.

<CardGroup cols={2}>
  <Card title="Vercel Connect" href="/integrations/vercel-connect">
    Request short-lived social provider tokens from Vercel Connect in a Vercel deployment.
  </Card>
</CardGroup>
